...
/***/ "./src/components/_default/header/Header.js":
/*!**************************************************!*\
  !*** ./src/components/_default/header/Header.js ***!
  \**************************************************/
/*! no static exports found */
...
function headerHandler(header, popup) {
	var loginBtn = header.querySelector(".js-lk-btn");
	var helpBtn = header.querySelector(".js-help-btn");
	var helpList = header.querySelector(".js-help-list");
...
var _InputValidator = __webpack_require__(/*! ../../scripts/partials/InputValidator.js */ "./src/scripts/partials/InputValidator.js");
...
function popupHandler(popup) {
    var closeBtn = popup.querySelector(".js-close-popup");
    var loginForm = popup.querySelector(".js-popup-form");
    loginForm.setAttribute("novalidate", true);

    var inputEmailElements = popup.querySelectorAll(".js-form-input");
    ...
    loginForm.addEventListener("submit", function (e) {
        ...
        var isValid = validateForm(inputEmailElements);
...
function validateForm(inputEmailElements) {
    ...
    var inputEmailInvalidClass = "error";

    for (var i = 0, len = inputEmailElements.length; i < len; i++) {

        var inputEmailValidator = new _InputValidator2.default({
...
function mainPageHandler(mainPage) {
    var serchForm = mainPage.querySelector(".js-search-form");
    serchForm.setAttribute("novalidate", true);
    var inputEmailElements = serchForm.querySelectorAll(".js-form-input");

    serchForm.addEventListener("submit", function (e) {
        e.preventDefault();

        var isValid = validateForm(inputEmailElements);
        var url = serchForm.action;

        if (isValid) {
            var data = new FormData(serchForm);
            data.append("ajax", "Y");
            makeRequest(url, data);
        }
    });
...
exports.default = mainPageHandler;
...
var _Header = __webpack_require__(/*! ../components/_default/header/Header.js */ "./src/components/_default/header/Header.js");

var _Header2 = _interopRequireDefault(_Header);

var _Main = __webpack_require__(/*! ../components/login/Main.js */ "./src/components/login/Main.js");

var _Main2 = _interopRequireDefault(_Main);

var _Main3 = __webpack_require__(/*! ../components/main/Main.js */ "./src/components/main/Main.js");
...
document.addEventListener("DOMContentLoaded", function () {
	...
	if (header) {
		new _Header2.default(header, popup);
	}

	if (popup) {
		new _Main2.default(popup);
	}

	if (mainPage) {
		new _Main4.default(mainPage);
	}
});
...
function InputValidator(options) {
    ...
    var filledClass = baseClass + "_filled";
